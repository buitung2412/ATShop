                        ...
                        <div class="product__discount__slider owl-carousel">
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg" data-setbg="{{url('public/uploads')}}/{{$sp->image}}">
                ...
                @foreach($allpro as $pro)
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="{{url('public/uploads')}}/{{$pro->image}}" style="background-image: url(&quot;img/product/product-1.jpg&quot;);">
                                <ul class="product__item__pic__hover">
                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                    <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                            ...
                            <div class="product__item__text">
                                <h6><a href="{{route('product',['id'=>$pro->id,'slug'=>Str::slug($pro->name)])}}">{{$pro->name}}</a></h6>
                                @if($pro->sale_price>0)
                                <h5>{{number_format($pro->sale_price)}} VNĐ</h5>
                                @else
